...
class MeditationActivity : AppCompatActivity(),
    ...
    companion object {
        ...
        const val CURRENT_MEDITATION_TIME = "current_time"
        const val START_MEDITATION_TIME = "starting_time"
    }
    ...
    private fun createAnimation(sharedPreferences: SharedPreferences) {
        ...
        mAnimation!!.inhaleColor = Tools.colorKeyToInt(resources, colorInhale!!)
        ...
        mAnimation!!.exhaleColor = Tools.colorKeyToInt(resources, colorExhale!!)
    }

    /**
     * Launches the help dialog
     */
    private fun launchHelpDialog() {
        stopMeditation()
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        ...
        if (key == getString(R.string.pref_seekbar_inhale_key)) {
            ...
            mAnimation!!.inhaleColor = Tools.colorKeyToInt(resources, colorString!!)
            ...
            mAnimation!!.exhaleColor = Tools.colorKeyToInt(resources, colorString!!)
